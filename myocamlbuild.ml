(* OASIS_START *)
(* DO NOT EDIT (digest: 7c5654c8c2045d7d7bc801ddedf7662b) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("src/core/camlimages", ["src/core"]);
          ("src/graphic/camlimages-graphic", ["src/graphic"]);
          ("src/gif/camlimages-gif", ["src/gif"]);
          ("src/freetype/camlimages-freetype2", ["src/freetype"]);
          ("src/ps/camlimages-ps", ["src/ps"]);
          ("src/xpm/camlimages-xpm", ["src/xpm"]);
          ("src/png/camlimages-png", ["src/png"]);
          ("src/tiff/camlimages-tiff", ["src/tiff"]);
          ("src/lablgtk/camlimages-lablgtk", ["src/lablgtk"]);
          ("src/jpeg/camlimages-jpeg", ["src/jpeg"]);
          ("src/lablgtk2/camlimages-lablgtk2", ["src/lablgtk2"])
       ];
     lib_c =
       [
