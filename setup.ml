...
(* OASIS_START *)
(* DO NOT EDIT (digest: 414f164d0b28c739e876d9e976089260) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "camlimages";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src/gif";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "camlimages-lib"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "camlimages-lib";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "camlimages-lib";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "0°u\027ÈU~†ûZ\014\"{\0075\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
